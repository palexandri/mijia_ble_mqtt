...
MQTT_TOPIC_HUMIDITY = 'office/mijia/outside/humidity'
MQTT_TOPIC_TEMPERATURE = 'office/mijia/outside/temperature'
MQTT_TOPIC_BATTERY = 'office/mijia/outside/battery'
MQTT_TOPIC_STATE = 'office/mijia/outside/status'

MQTT_PUBLISH_DELAY = 60
MQTT_CLIENT_ID = 'mijia'

MQTT_SERVER = '172.19.0.3'
MQTT_USER = 'mqttuser'
MQTT_PASSWORD = 'mqttpassword'

MIJIA_BTLE_ADDRESS = '4C:65:A8:DE:84:88'
